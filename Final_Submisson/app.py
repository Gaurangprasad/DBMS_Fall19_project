...
def query5():
    ...
    print("Search for unemployment informantion for a specific county or region (in New York State) and for a particular year.")
    print()
    print()
...
def query6():
    print("6. Relationship between unemployment and arrests.")
    print("Search for unemployment & arrests informantion for a specific county and for a particular year.")
    print()
    print()
    county = input("Enter county: ")
    year = input("Enter year: ")
    ...
    adultArrestDF['Total Beneficiaries'] = jsonDF['Beneficiaries'][0]
    adultArrestDF['Total Benefits'] = jsonDF['Benefits'][0]
    print(tabulate(adultArrestDF, headers=['county', 'yr', 'drug_fel.', 'vio_feln.', 'dwi_feln', 'other_feln.', 'drug_mis', 'dwi_mis', 'property_mis', 'other_mis', 'total_beneficiaries', 'total_benefits'], tablefmt='fancy_grid'))
...
if __name__ == "__main__":
    ...
    if(parser['view']):
        print("Here are the list of queries supported by the application. To run a query, do python app.py --query QUERY_NUM \nwhere QUERY_NUM is the number in the following list: ")
        print()
        print()
        print("1. Where can I get some alcohol around me?")
