DROP TABLE ADULT_ARRESTS;

DROP TABLE CITY_ZIP_MAP, LIQUOR_AGENCY, LICENSE_TYPES;
DROP TABLE LIQUOR_LICENSE;

DROP TABLE HEALTH_DEPT_COUNTY_MAP,FOOD_SERVICE_VIOLATIONS,FOOD_SERVICE_OPERATOR;
DROP TABLE FOOD_SERVICE_INSPECTIONS;

DROP TABLE UNEMPLOYMENT_BENEFICIARIES;
...
CREATE TABLE LIQUOR_LICENSE(
  ...
  address varchar(255),
  zipcode int REFERENCES city_state_zip_map(zip),
